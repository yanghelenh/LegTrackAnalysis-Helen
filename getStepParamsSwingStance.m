...
%   10/11/22 - HHY - modified groupStepParamsBySwingStance to work on all
%       legStep parameters, including stepInds, stepT, and stepWhichLeg;
%       bug in how stepInds, stepT, and stepWhichLeg were assigned before
%
...
%         'stepSwingStance', 'swingStanceMethod', 'stepT','legIDs'};

    irregularParamNames = {'maxIndsAll', 'minIndsAll', 'maxWhichLeg',...
        'minWhichLeg','userSelVal', 'stepSwingStance', ...
        'swingStanceMethod', 'legIDs'};
